"""Custom exceptions for Equity Changes Service"""


class EquityChangesError(Exception):
    """Base exception for Equity Changes service errors"""
...
class NotFoundError(EquityChangesError):
    def __init__(self, detail: str, code: str = "NOT_FOUND"):
        super().__init__(detail, code, 404)


class ValidationError(EquityChangesError):
