...
class FundTransactionBase(BaseModel):
    ...
    transaction_type: Literal["contribution", "disbursement", "transfer_in", "transfer_out", "investment", "appreciation", "depreciation", "adjustment"] = Field(...)
...
class NetAssetsChangeBase(BaseModel):
    ...
    change_type: Literal["contribution", "grant", "investment_return", "expenditure", "reclassification", "depreciation", "impairment"] = Field(...)
