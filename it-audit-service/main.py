"""Vimbai IT Audit Service - Audit and forensic analysis. Port: 8351"""
import os, uuid
...
app = FastAPI(title="Vimbai IT Audit Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="it-audit-service", instrument_app=app)
except ImportError:
    TRACER = None
