"""Vimbai AI Readiness Service. Port: 8375"""
import os, uuid, time
...
SERVICE_NAME = "ai-readiness-service"
...
app = FastAPI(title="Vimbai AI Readiness Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="ai-readiness-service", instrument_app=app)
except ImportError:
    TRACER = None
