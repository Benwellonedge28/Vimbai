...
@app.get("/")
async def root():
    return {"service": SERVICE_NAME, "version": SERVICE_VERSION, "description": "Net realizable value and scrap value calculations"}
...
async def calculate_residual_value(
    original_cost: float,
...
async def calculate_nrv_for_inventory(
    ...
    estimated_selling_expenses: float
):
