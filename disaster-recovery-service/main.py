"""Vimbai Disaster Recovery Service. Port: 8378"""
import os, uuid, time
...
SERVICE_NAME = "disaster-recovery-service"
...
app = FastAPI(title="Vimbai Disaster Recovery Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="disaster-recovery-service", instrument_app=app)
except ImportError:
    TRACER = None
