...
class TestRequestIDMiddleware:
    def test_request_id_generated(self):
        from shared.middleware import setup_middleware, RequestIDMiddleware
        app = FastAPI()
...
class TestHealthEndpoint:
    ...
    def test_readiness_with_registered_check(self):
        from shared.health import setup_health_endpoint, register_health_check, _health_checks
