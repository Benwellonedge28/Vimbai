    ...
    def test_job_cost(self):
        resp = self.client.post(
            ...
            json={
                "company_id": "comp-1",
                "job_id": "JOB-001",
                "job_name": "Custom Build",
                "direct_materials": 5000,
                "direct_labour": 3000,
                "direct_labour_hours": 150,
                "overhead_rate": 25,
                "additional_costs": [{"description": "Special tooling", "amount": 500, "type": "overhead"}],
                "units_produced": 10,
            },
        )
        data = resp.json()
...
class TestGovernmentGrantsService:
    ...
    def test_asset_grant(self):
        resp = self.client.post(
            ...
            json={
                "company_id": "comp-1",
                "grant_name": "Industrial Development Grant",
