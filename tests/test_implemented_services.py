...
class TestTaxCalculationService:
    ...
    def test_income_tax_progressive(self):
        resp = self.client.post(
            "/calculate",
            json={"company_id": "comp-1", "tax_type": "income_tax", "taxable_amount": 50000, "fiscal_year": 2026},
        )
        data = resp.json()
        assert resp.status_code == 200
    ...
    def test_vat_calculation(self):
        resp = self.client.post("/calculate", json={"company_id": "comp-1", "tax_type": "vat", "taxable_amount": 1000})
        data = resp.json()
...
class TestProfitLossService:
    ...
    def test_pnl_comparison(self):
        resp = self.client.post(
            "/compare",
            params={"company_id": "comp-1", "previous_revenue": 800000, "previous_net_income": 100000},
            json={
                "company_id": "comp-1",
                "fiscal_year_start": "2026-01-01",
                "fiscal_year_end": "2026-12-31",
    ...
    def test_trading_account(self):
        resp = self.client.post(
            ...
            json={
                ...
                "opening_stock": 10000,
                "purchases": 50000,
                "carriage_inward": 2000,
                "closing_stock": 15000,
                "sales": 100000,
                "sales_returns": 5000,
                "direct_wages": 8000,
                "factory_overhead": 5000,
            },
        )
        data = resp.json()
        assert resp.status_code == 200
            ...
            json={
                ...
                "errors": [
                    ...
                    },
                    {
                        ...
                        "amount": 100,
                        "account_affected": "Equipment",
                        "correct_debit": "Machinery",
                        "correct_credit": "Cash",
                    },
                ],
            },
...
class TestPartnershipSaleService:
    ...
    def test_retirement_calculation(self):
        resp = self.client.post(
            ...
            json={
                "company_id": "comp-1",
                "outgoing_partner_id": "p1",
                "outgoing_partner_name": "Alice",
                "capital_balance": 100000,
                "share_of_goodwill": 20000,
                "share_of_reserves": 5000,
                "loan_to_partner": 5000,
