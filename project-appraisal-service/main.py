...
class AppraisalRequest(BaseModel):
    company_id: str; project_name: str
...
class AppraisalResult(BaseModel):
    ...
    company_id: str; project_name: str
    npv: float; irr: float; payback_period: float
    discounted_payback: float; profitability_index: float
    recommendation: str; cash_flow_analysis: List[Dict] = []
...
async def appraise_project(req: AppraisalRequest):
    ...
    return AppraisalResult(
        company_id=req.company_id, project_name=req.project_name,
        ...
        recommendation=rec, cash_flow_analysis=analysis
    )
