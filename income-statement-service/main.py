...
async def prepare_income_statement(req: IncomeStatementRequest):
    ...
    return IncomeStatement(
        ...
        revenue=round(req.revenue, 2),
        other_income=round(req.other_income, 2),
        ...
        interest_expense=round(req.interest_expense, 2),
        other_expenses=round(req.other_expenses, 2),
