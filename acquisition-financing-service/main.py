...
async def structure_acquisition_financing(request: AcquisitionFinancingRequest):
    ...
    option_low_leverage = {
        ...
        "interest_coverage": request.deal_value * 0.2 / (request.deal_value * 0.4 * request.interest_rate) if request.interest_rate else 0
    }
    ...
    option_high_leverage = {
        ...
        "interest_coverage": request.deal_value * 0.2 / (request.deal_value * 0.7 * request.interest_rate) if request.interest_rate else 0
    }
    ...
    return AcquisitionFinancingResponse(
        ...
        leverage_analysis={"total_leverage": round(leverage, 4), "interest_expense": interest_expense, "after_tax_cost": after_tax_cost},
