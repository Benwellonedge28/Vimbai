"""Vimbai Observability Service. Port: 8388"""
import os, uuid, time
...
app = FastAPI(title="Vimbai Observability Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="observability-service", instrument_app=app)
except ImportError:
    TRACER = None
