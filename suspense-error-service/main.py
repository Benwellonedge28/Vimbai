...
class SuspenseError(BaseModel):
    ...
    correct_debit: Optional[str] = None
    correct_credit: Optional[str] = None
...
class SuspenseResult(BaseModel):
    ...
    company_id: str
    period: str
    original_suspense_balance: float
    total_errors_found: int
    corrected_suspense_balance: float
