...
async def analyze_capital_budget(request: CapitalBudgetingRequest):
    ...
    for project in request.projects:
        ...
        projects_analyzed.append(InvestmentProject(
    ...
    return CapitalBudgetingResponse(
        ...
        recommendations=["Focus on high NPV projects within budget constraints", "Consider project interdependencies", "Review IRR against cost of capital"]
    )
