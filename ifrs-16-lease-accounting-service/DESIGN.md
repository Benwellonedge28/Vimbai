# Design Document: ifrs-16-lease-accounting-service

## 1. Overview
The `ifrs-16-lease-accounting-service` is a microservice within the Vimbai Financial Accounting Platform. It is responsible for handling specific financial logic, data processing, or integration tasks related to its domain.
