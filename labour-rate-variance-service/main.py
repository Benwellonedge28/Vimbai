...
@app.post("/calculate")
async def calculate_rate_variance(standard_rate: float, actual_rate: float, actual_hours: float):
    """
...
async def calculate_wages_variance(standard_wage_rate: float, actual_wage_rate: float, hours_worked: float):
...
async def total_rate_variance(standard_rate_per_hour: float, actual_rate_per_hour: float, total_hours_worked: float):
