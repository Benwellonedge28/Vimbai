"""Vimbai High Availability Service. Port: 8384"""
import os, uuid, time
...
SERVICE_NAME = "high-availability-service"
...
app = FastAPI(title="Vimbai High Availability Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="high-availability-service", instrument_app=app)
except ImportError:
    TRACER = None
