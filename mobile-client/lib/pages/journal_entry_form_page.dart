          ...
          child: Column(
            children: [
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          onChanged: (value) => line = JournalLine(accountNumber: value, debit: line.debit, credit: line.credit, description: line.description),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Required';
                            }
                        ...
                        TextFormField(
                          ...
                          onChanged: (value) => line = JournalLine(accountNumber: line.accountNumber, debit: line.debit, credit: line.credit, description: value),
                        ),
                        Align(
              ...
              ElevatedButton(
                ...
                child: const Text('Submit Journal Entry'),
              ),
            ],
          ),
        ),
