"""Vimbai Edge Computing Service. Port: 8380"""
import os, uuid, time
...
SERVICE_NAME = "edge-computing-service"
...
app = FastAPI(title="Vimbai Edge Computing Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="edge-computing-service", instrument_app=app)
except ImportError:
    TRACER = None
