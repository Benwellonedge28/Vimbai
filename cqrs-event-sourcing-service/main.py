"""Vimbai CQRS Event Sourcing Service. Port: 8376"""
import os, uuid, time
...
SERVICE_NAME = "cqrs-event-sourcing-service"
...
app = FastAPI(title="Vimbai CQRS Event Sourcing Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="cqrs-event-sourcing-service", instrument_app=app)
except ImportError:
    TRACER = None
