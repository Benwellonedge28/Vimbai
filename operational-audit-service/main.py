"""Vimbai Operational Audit Service - Audit and forensic analysis. Port: 8352"""
import os, uuid
...
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="operational-audit-service", instrument_app=app)
except ImportError:
    TRACER = None
