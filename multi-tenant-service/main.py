"""Vimbai Multi Tenant Service. Port: 8387"""
import os, uuid, time
...
SERVICE_NAME = "multi-tenant-service"
...
app = FastAPI(title="Vimbai Multi Tenant Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="multi-tenant-service", instrument_app=app)
except ImportError:
    TRACER = None
