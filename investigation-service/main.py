"""Vimbai Investigation Service - Risk management and investigation. Port: 8333"""
import os, uuid
...
app = FastAPI(title="Vimbai Investigation Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="investigation-service", instrument_app=app)
except ImportError:
    TRACER = None
