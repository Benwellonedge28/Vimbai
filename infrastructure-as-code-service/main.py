"""Vimbai Infrastructure as Code Service. Port: 8385"""
import os, uuid, time
...
SERVICE_NAME = "infrastructure-as-code-service"
...
app = FastAPI(title="Vimbai Infrastructure as Code Service", version="2.0.0", docs_url="/docs")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
try:
    from shared.tracing import setup_tracing; TRACER = setup_tracing(service_name="infrastructure-as-code-service", instrument_app=app)
except ImportError:
    TRACER = None
