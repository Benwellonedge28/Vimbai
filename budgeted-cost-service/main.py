...
app = FastAPI(title="FinAcc Budgeted Cost Service", version=SERVICE_VERSION, docs_url="/docs")
...
async def calculate_total_budget(
    budgeted_costs: List[dict]  # [{"item": "name", "amount": x}]
):
...
async def compare_budgeted_to_actual_output(
