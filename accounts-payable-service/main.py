...
async def analyze_accounts_payable(request: APAnalysisRequest):
    ...
    aging_analysis = [
        {
            "bucket": "0-30 days",
            "amount": round(aging_0_30, 2),
            "percentage": round(aging_0_30 / total_outstanding * 100, 2) if total_outstanding else 0,
        },
        {
            "bucket": "31-60 days",
            "amount": round(aging_31_60, 2),
            "percentage": round(aging_31_60 / total_outstanding * 100, 2) if total_outstanding else 0,
        },
        {
            "bucket": "61-90 days",
            "amount": round(aging_61_90, 2),
            "percentage": round(aging_61_90 / total_outstanding * 100, 2) if total_outstanding else 0,
        },
        {
            "bucket": "Over 90 days",
            "amount": round(aging_over_90, 2),
            "percentage": round(aging_over_90 / total_outstanding * 100, 2) if total_outstanding else 0,
        },
    ]
